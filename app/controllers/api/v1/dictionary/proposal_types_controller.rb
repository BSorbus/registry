class Api::V1::Dictionary::ProposalTypesController < Api::V1::BaseApiController
  ...
  def index
    ...
    render json: proposal_types, each_serializer: Api::V1::ProposalTypeSerializer, root: 'proposal_types', meta: {total_count: proposal_types.count}, status: :ok
  end
  ...
  def show
    ...
    if proposal_type.present?
      ...
      render json: proposal_type, serializer: Api::V1::ProposalTypeSerializer, root: 'proposal_type' #, meta: {total_count: 1}
