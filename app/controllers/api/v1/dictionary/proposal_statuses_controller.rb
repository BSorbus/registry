class Api::V1::Dictionary::ProposalStatusesController < Api::V1::BaseApiController
  ...
  def index
    ...
    render json: proposal_statuses, each_serializer: ProposalStatusSerializer, root: 'proposal_statuses', meta: {total_count: proposal_statuses.count}, status: :ok
  end
  ...
  def show
    ...
    if proposal_status.present?
      ...
      render json: proposal_status, serializer: ProposalStatusSerializer, root: 'proposal_status' #, meta: {total_count: 1}
