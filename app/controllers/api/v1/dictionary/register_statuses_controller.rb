class Api::V1::Dictionary::RegisterStatusesController < Api::V1::BaseApiController
  ...
  def index
    ...
    render json: register_statuses, each_serializer: RegisterStatusSerializer, root: 'register_statuses', meta: {total_count: register_statuses.count}, status: :ok
  end
  ...
  def show
    ...
    if register_status.present?
      ...
      render json: register_status, serializer: RegisterStatusSerializer, root: 'register_status' #, meta: {total_count: 1}
