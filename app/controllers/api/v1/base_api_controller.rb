module Api
  module V1
    class BaseApiController < ApplicationController
      ...
      # set inside inherited controllers or hier
      # before_action :authenticate_system_param_token, except: [:token]
      # or
      # before_action :authenticate_system_param_basic, except: [:token]
